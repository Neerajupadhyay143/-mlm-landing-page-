        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div>
                <h1 className="section_heading">First step to invest in T A Trading</h1>
                <p className="para">Welcome to  T A Trading, the world’s first 100% decentralized platform for everyone to invest &amp; earn profit with multi-trading assets.</p>
                  ...
                  <div>
                    <div>
                      <ul className="header_socail_icons">
                        ...
                        <li><a href="https://t.me/htx_in" target="_blank"><i className="fa fa-telegram" /></a></li>
